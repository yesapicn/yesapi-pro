...
<div>
  <a target="_blank" href="http://java.test.yesapi.cn/platform">🔍 在线预览</a>
</div>

## 项目简介

[Platform开放平台](http://java.test.yesapi.cn/platform) 是基于 Vue3 + Vite5 + TypeScript5 + Element-Plus + Pinia 等主流技术栈构建的接口大师开放平台。
...
![登录](img/platform/project_pic1.png)

![主页](img/platform/project_pic2.png)
...
# 上传文件至远程服务器
最后把dist目录里面全部的文件复制替换到docker-static/platform/，更新到生产环境即可。
```
